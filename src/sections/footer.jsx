  ...
  return (
    <footer className="w-full bg-blue mt-48" id="footer">
      ...
      <section className="widgets container pt-14 mx-auto w-5/6 max-w-6xl flex flex-col items-start justify-start sm:flex-row sm:justify-between sm:gap-10">
        <Widget title="Contact" titleClassName="text-white">
          ...
          <address className="not-italic">
            ...
            <ContactCard
              ...
              link="https://www.instagram.com/cancun concierge/"
              text="Instagram"
              color="text-white"
              iconColor="fill-white"
            />
        ...
        <Widget title="ABOUT US" extraClassName="about us max-w-lg sm:order-first" titleClassName="text-white">
